...
# -----------------------------
# Absolute path so this works no matter what Streamlit Cloud's working
# directory happens to be when it runs this page.
_BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
model = joblib.load(os.path.join(_BASE_DIR, "models", "maternal_risk_model.pkl"))
